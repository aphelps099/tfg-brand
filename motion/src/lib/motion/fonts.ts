/* ═══════════════════════════════════════════════════════
   ...
   TFG's brand fonts are self-hosted (globals.css):
   GT America Extended and Tobias, plus Roboto Mono from
   Google Fonts. No Typekit kit loads by default — the kit
   loader stays available for one-off overrides.
   ═══════════════════════════════════════════════════════ */
...
export function builtinFonts(): FontOption[] {
  return [
    ...
    { family: 'Roboto Mono',         label: 'Roboto Mono',         source: 'local' },
